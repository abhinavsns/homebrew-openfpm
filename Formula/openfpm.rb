  ...
  def install
    ...
    cd "build" do
      system "cmake", "..", *std_cmake_args,
              ...
              "-DMPI_VENDOR=openmpi",
              "-DMPI_C_COMPILER=#{Formula["open-mpi"].opt_prefix}/bin/mpicc",
              "-DMPI_CXX_COMPILER=#{Formula["open-mpi"].opt_prefix}/bin/mpic++",
              "-DMPIEXEC_EXECUTABLE=#{Formula["open-mpi"].opt_prefix}/bin/mpiexec",
